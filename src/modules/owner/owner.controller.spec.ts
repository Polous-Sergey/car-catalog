...
describe('OwnerController', () => {
  ...
  describe('createOwner', () => {
    it('should create owner', async () => {
      ...
      expect(result.car).toHaveProperty(
    ...
    it('should throw RelationNotFoundException if car not found (createOwner)', async () => {
      const result = await ownerController
        .createOwner({
          ...createOwner,
          carId: uuidString,
        })
  ...
  describe('updateOwner', () => {
    it('should update owner', async () => {
      ...
      const newCarId = await dbTestHelperService.createCar(
        createCar,
        manufacturerId,
      );
      ...
      expect(result).toHaveProperty(
        'purchaseDate',
        new Date(updatedOwner.purchaseDate),
      );
